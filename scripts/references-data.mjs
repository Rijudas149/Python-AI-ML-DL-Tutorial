...
const CATALOG = {
  ...
  'openstax-calc1': {
    ...
    description: 'Free textbook covering limits, derivatives, integration, and L\'Hôpital\'s rule.',
  },
  'mit-1801': {
    id: 'mit-1801',
    ...
    description: 'Full lecture notes and problem sets on limits, differentiation, and integration.',
  },
  'real-python-numpy': {
    id: 'real-python-numpy',
    title: 'NumPy Tutorial — Real Python',
    source: 'Real Python',
    type: 'article',
    url: 'https://realpython.com/numpy-tutorial/',
    description: 'Practical NumPy arrays, broadcasting, and numerical computing for data science.',
  },
  'real-python-pandas': {
    id: 'real-python-pandas',
    title: 'Pandas DataFrames — Real Python',
    source: 'Real Python',
    type: 'article',
    url: 'https://realpython.com/pandas-dataframe/',
    description: 'Hands-on guide to loading, filtering, and analyzing tabular data with pandas.',
  },
  'towards-data-science-ml': {
    id: 'towards-data-science-ml',
    title: 'Machine Learning Tutorials — Towards Data Science',
    source: 'Towards Data Science',
    type: 'article',
    url: 'https://towardsdatascience.com/tagged/machine-learning',
    description: 'Community articles on ML concepts, implementations, and best practices.',
  },
...
export const TOPIC_REFERENCES = {
  ...
  'math-limits': pick('khan-limits', 'pauls-limits', 'khan-lhopital', '3blue1brown-calculus'),
  'math-derivatives': pick('khan-derivatives', 'pauls-derivatives', '3blue1brown-calculus', 'pytorch-autograd'),
  'math-derivative-rules': pick('khan-derivatives', 'pauls-derivatives', 'pauls-lhopital', '3blue1brown-calculus'),
...
const REFERENCE_RULES = [
  ...
  { test: (h, id) => /limit|deriv|integral|taylor|calculus|chain rule|jacobian|hessian|partial|l.?h[oô]pital/.test(h) || /^math-(limits|deriv|integral|taylor|partial|gradient|chain|jacobian)/.test(id), refs: ['khan-limits', 'pauls-limits', 'khan-lhopital', 'openstax-calc1', '3blue1brown-calculus', 'mit-1801'] },
